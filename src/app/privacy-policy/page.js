      ...
      <main>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 prose prose-lg prose-slate text-gray-700">
            ...
            <p className="mb-6">You have the right to access, correct, or delete your personal information. If you wish to exercise these rights, please contact us at info@eklavyarelocation.com.</p>
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-gray-100 mt-12">
                ...
                <p className="text-gray-600">If you have any questions about this Privacy Policy, please contact us at info@eklavyarelocation.com or call us at +91 8683808955.</p>
            </div>
          </div>
        </section>
      </main>
