...
export const metadata = {
  title: "Contact Us | Eklavya Relocation",
  description: "Get in touch with Eklavya Relocation for a free quote on our packing and moving services. We are here to help you move.",
};
                ...
                <div className="reveal">
                  ...
                  <div className="space-y-10">
                    {[
                      ...
                      { icon: "fa-envelope", title: "General Inquiries", detail: "info@eklavyarelocation.com", color: "bg-purple-600" }
                    ].map((item, i) => (
                    ...
                    <form className="space-y-6 flex-grow flex flex-col">
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="relative group">
                                <input type="text" className="w-full bg-slate-50 border-none px-8 py-5 rounded-[2rem] outline-none focus:ring-4 focus:ring-orange-50 font-medium transition-all peer" placeholder="Full Name" />
                            ...
                            <div className="relative group">
                                <input type="tel" className="w-full bg-slate-50 border-none px-8 py-5 rounded-[2rem] outline-none focus:ring-4 focus:ring-orange-50 font-medium transition-all peer" placeholder="Mobile Number" />
                                <div className="absolute inset-0 border-2 border-[#f27904] rounded-[2rem] opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none"></div>
                            </div>
                        </div>
                        
                        <div className="relative group">
                            <select className="w-full bg-slate-50 border-none px-8 py-5 rounded-[2rem] outline-none focus:ring-4 focus:ring-orange-50 font-medium appearance-none transition-all">
                        ...
                        <div className="relative group flex-grow">
                            <textarea rows="5" className="w-full bg-slate-50 border-none px-8 py-5 rounded-[2rem] outline-none focus:ring-4 focus:ring-orange-50 font-medium transition-all resize-none" placeholder="Share your moving requirements..."></textarea>
                            <div className="absolute inset-0 border-2 border-[#f27904] rounded-[2rem] opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none"></div>
                        </div>

                        <button type="submit" className="group relative overflow-hidden bg-[#f27904] text-white px-10 py-6 rounded-[2rem] font-bold text-lg shadow-2xl shadow-orange-100 hover:-translate-y-1 transition-all active:scale-95">
