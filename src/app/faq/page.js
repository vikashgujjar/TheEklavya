        ...
        <section className="py-20 bg-slate-50 border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <a href="mailto:theeklavyarelocation007@gmail.com" className="bg-white text-[#0f458b] border border-gray-200 px-8 py-3 rounded-full font-bold hover:bg-gray-50 transition-all flex items-center gap-2">
